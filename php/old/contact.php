...
$subject ="Новая заявка с сайта icanweb.ru";
...
$header .= "From: Новая заявка <info.icanweb@gmail.com>\n\n";	
$mail = mail("info.icanweb@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
